...
utils.benchmark_regex = '[^Benchmark$|^Benchmark\\P{Ll}.*]'


---@param strategy string
---@param args table
---@return table | nil
function utils.get_strategy_config(strategy, args)
  local config = {
    dap = function()
      return {
        type = 'go',
...
--@return boolean
function utils.is_benchmark_test(test_func_name)
...
---@return table
function utils.get_test_function_debug_args(func_name)
